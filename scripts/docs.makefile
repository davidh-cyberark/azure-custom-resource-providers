...
PLANTUML_DEFAULT_URL := https://github.com/plantuml/plantuml/releases/download/v1.2024.7/plantuml.jar
...
%.md.sha256sum : %.md | $(PLANTUML_JAR) doctoc
...
vardump::
	...
	@echo "docs.makefile: DOCFILE_OBJS: $(DOCFILE_OBJS)"
